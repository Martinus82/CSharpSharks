...
namespace RefVsValueTypes
{
    ...
    {
        // Reference types (class-es) are muttable: 
        ...
        // (in new DotNet 5.0 we have "record" type which solves the issue of muttability of the reference types (classes). A "record" is still a class but it is not possible to change it. DotNet takes care about instance comparison...)
